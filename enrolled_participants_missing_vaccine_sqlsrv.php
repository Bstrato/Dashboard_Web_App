...
$table_name="enrolled_participants_missing_vaccine_datab";

if(isset($_POST['listings']) && isset($_POST['SEARCH'])){

    $table_name=$_POST['enrolled_participants_missing_vaccine_datab'];
   
   if(!empty($_POST['enrolled_participants_missing_vaccine_datab'])){
...
$cluster_query = "SELECT cluster, count(cluster) as cnt2 FROM enrolled_participants_missing_vaccine_datab GROUP BY cluster ORDER BY cluster";
...
/*
$grouping = '';
$grouping_query = "SELECT groupings, count(groupings) as cnt2 FROM enrolled_participants_missing_vaccine_datab GROUP BY groupings ORDER BY groupings";
...
*/
$district = '';
$district_query ="SELECT district, count(district) as cnt3 FROM enrolled_participants_missing_vaccine_datab GROUP BY district ORDER BY district";
...
$query_all="SELECT * FROM EPIMAL003_Master.dbo.enrolled_participants_missing_vaccine_datab";
...
if (isset($_POST['filter_cluster'],$_POST['filter_grouping'], $_POST['filter_district']) && (!empty(trim($_POST['filter_cluster'])) && !empty(trim($_POST['filter_grouping'])) && !empty(trim($_POST['filter_district']))))
{
  ...
  $query_all="SELECT * FROM enrolled_participants_missing_vaccine_datab";
...
<!-- Content -->
        ...
        <div class="content">
        <div class="buy-form">
        <h4 class="page-title" align="centre">MISSING VACCINE</h4>
