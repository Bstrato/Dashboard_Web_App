...
$table_name="EPIMAL003_Master.dbo.visits_missing_rtss";

if(isset($_POST['listings']) && isset($_POST['SEARCH'])){

    $table_name=$_POST['EPIMAL003_Master.dbo.visits_missing_rtss'];
   
   if(!empty($_POST['EPIMAL003_Master.dbo.visits_missing_rtss'])){
...
$cluster_query = "SELECT cluster, count(cluster) as cnt2 FROM EPIMAL003_Master.dbo.visits_missing_rtss GROUP BY cluster ORDER BY cluster";
...
$grouping = '';
$grouping_query = "SELECT groupings, count(groupings) as cnt2 FROM EPIMAL003_Master.dbo.visits_missing_rtss GROUP BY groupings ORDER BY groupings";
...
$district = '';
$district_query ="SELECT district, count(district) as cnt3 FROM EPIMAL003_Master.dbo.visits_missing_rtss GROUP BY district ORDER BY district";
...
<!-- Content -->
        ...
        <div class="content">
        <div class="buy-form">
        <h4 class="page-title" align="centre">MISSING VISITS DATA - LISTINGS</h4>
