...
$cluster_query = "SELECT cluster, count(cluster) as cnt2 FROM Weekly_Listings_current_datab GROUP BY cluster ORDER BY cluster";
...
$grouping = '';
$grouping_query = "SELECT groupings, count(groupings) as cnt2 FROM Weekly_Listings_current_datab GROUP BY groupings ORDER BY groupings";
...
$district = '';
$district_query ="SELECT district, count(district) as cnt3 FROM Weekly_Listings_current_datab GROUP BY district ORDER BY district";
...
$query_all="SELECT * FROM Weekly_Listings_current_datab";
...
<!-- Content -->
        ...
        <div class="content">
        <div class="buy-form">
        <h4 class="page-title">CURRENT LISTINGS FOR THE WEEK</h4>
