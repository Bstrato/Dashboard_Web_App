...
$table_name="EPIMAL003_Master.dbo.cause_of_death_datab";

if(isset($_POST['listings']) && isset($_POST['SEARCH'])){

    $table_name=$_POST['EPIMAL003_Master.dbo.cause_of_death_datab'];
   
   if(!empty($_POST['EPIMAL003_Master.dbo.cause_of_death_datab'])){
...
$cluster_query = "SELECT cluster, count(cluster) as cnt2 FROM EPIMAL003_Master.dbo.cause_of_death_datab GROUP BY cluster ORDER BY cluster";
...
$grouping = '';
$grouping_query = "SELECT groupings, count(groupings) as cnt2 FROM EPIMAL003_Master.dbo.cause_of_death_datab GROUP BY groupings ORDER BY groupings";
...
$district = '';
$district_query ="SELECT district, count(district) as cnt3 FROM EPIMAL003_Master.dbo.cause_of_death_datab GROUP BY district ORDER BY district";
...
$query_all="SELECT * FROM EPIMAL003_Master.dbo.cause_of_death_datab";
...
<!-- Content -->
        ...
        <div class="content">
        <div class="buy-form">
        <h4 class="page-title" align="centre">LIST OF DEATHS</h4>
...
<td> <?php echo $row['determinant']; ?></td>
