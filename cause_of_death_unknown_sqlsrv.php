...
$table_name="EPIMAL003_Master.dbo.cause_of_death_unknown";

if(isset($_POST['listings']) && isset($_POST['SEARCH'])){

    $table_name=$_POST['EPIMAL003_Master.dbo.cause_of_death_unknown'];
   
   if(!empty($_POST['EPIMAL003_Master.dbo.cause_of_death_unknown'])){
...
$cluster_query = "SELECT cluster, count(cluster) as cnt2 FROM EPIMAL003_Master.dbo.cause_of_death_unknown GROUP BY cluster ORDER BY cluster";
...
/*
$grouping = '';
$grouping_query = "SELECT groupings, count(groupings) as cnt2 FROM EPIMAL003_Master.dbo.cause_of_death_unknown GROUP BY groupings ORDER BY groupings";
...
*/
$district = '';
$district_query ="SELECT district, count(district) as cnt3 FROM EPIMAL003_Master.dbo.cause_of_death_unknown GROUP BY district ORDER BY district";
...
$query_all="SELECT * FROM EPIMAL003_Master.dbo.cause_of_death_unknown";
...
<!-- Content -->
        ...
        <div class="content">
        <div class="buy-form">
        <h4 class="page-title" align="centre">CAUSE OF DEATH UNKNOWN - LISTINGS</h4>
