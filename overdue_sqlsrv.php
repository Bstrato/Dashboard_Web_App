...
$table_name="Over_Due_Listings_datab";

if(isset($_POST['listings']) && isset($_POST['SEARCH'])){

    $table_name=$_POST['Over_Due_Listings_datab'];
   
   if(!empty($_POST['Over_Due_Listings_datab'])){
...
$cluster_query = "SELECT cluster, count(cluster) as cnt2 FROM Over_Due_Listings_datab GROUP BY cluster ORDER BY cluster";
...
$grouping = '';
$grouping_query = "SELECT groupings, count(groupings) as cnt2 FROM Over_Due_Listings_datab GROUP BY groupings ORDER BY groupings";
...
$district = '';
$district_query ="SELECT district, count(district) as cnt3 FROM Over_Due_Listings_datab GROUP BY district ORDER BY district";
...
$query_all="SELECT * FROM Over_Due_Listings_datab";
...
<!-- Content -->
        ...
        <div class="content">
        <div class="buy-form">
        <h4 class="page-title">OVERDUE LISTINGS</h4>
