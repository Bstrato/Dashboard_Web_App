...
<link rel="stylesheet" type="text/css" href="assets/css/style.css">
 ...
 <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"> 
	...
	<div class="page-wrapper bg-wrapper">
            <div class="content">
            	<p style="color:black; font-size:20px;"><strong>EXPOSED CLUSTER</strong></p>
                <div class="row">
                    <div class="col-sm-12">
					<div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        ...
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                ...
                                <span class="widget-title2"><a href="enhance.php" style="color:white";>Enhanced Enrolled </a> <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                ...
                <br/>
 				 ...
 				 <div class="row">
                    <div class="col-md-15">
						<div class="buy-form">
						<h4 class="page-title">SUMMARY BY GENDER FOR EXPOSED</h4>
							<div class="table">
                ...
                <p style="color:black; font-size:20px;"><strong>UNEXPOSED CLUSTER</strong></p>
                <div class="row">
                    <div class="col-sm-12">
					<div class="row">
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">	
                                ...
                                <span class="widget-title3"> <a href="" style="color:white";> Enhanced
                                 Enrolled </a> <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
              ...
              <br>
                 ...
                 <div class="row">   
                    <div class="col-md-8">
						<div class="buy-form">
						  <h4 class="page-title">SUMMARY BY GENDER FOR UNEXPOSED</h4>
							<div class="table">
                    ...
                    <div class="col-md-8">
                        <div class="buy-form">
                        <h4 class="page-title">SUMMARY BY GENDER FOR ACTIVE AND ENHANCED (EXPOSED AND UNEXPOSED)</h4>
                            <div class="table">
                                <table class="table table-striped custom-table mb-0  cstable ">
                                        <tr>
                                            <th>Group</th>
