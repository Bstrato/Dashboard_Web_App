...
include 'model/weekly_report_query.php';
?>
...
<!-- Content -->
        ...
        <div class="content">
        <div class="buy-form">
        <h4 class="page-title" align="center">WEEKLY CUMULATIVE VISITS PERFORMED FOR EXPOSED </h4></br>
...
<div>
  ...
  <tr>
    <td class="tg-0lax">Catch Ups</td>
    <td class="tg-0lax"><?php echo $row_a['catch_wkv1'];?></td>
    <td class="tg-0lax"><?php echo $row_b['catch_wkv2'];?></td>
    <td class="tg-0lax"><?php echo $row_c['catch_wkv3'];?></td>
    <td class="tg-0lax"><?php echo $row_d['catch_wkv4'];?></td>
    <td class="tg-0lax"><?php echo $row_e['catch_wkv5'];?></td>
    <td class="tg-0lax"><?php echo $row_f['catch_wkv6'];?></td>
    <td class="tg-0lax"><?php echo $row_g['catch_wkv7'];?></td>
    <td class="tg-0lax"><?php echo $row_h['catch_wkv8'];?></td>
    <td class="tg-0lax"><?php echo $row_i['catch_wkv9'];?></td>
    <td class="tg-0lax"><?php echo $row_j['wk_std_con_catch'];?></td>
  </tr>
  </tbody>
</table>
