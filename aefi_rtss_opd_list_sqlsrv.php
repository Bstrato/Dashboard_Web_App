...
$table_name="aefi_Rtss_opd_list_datab";

if(isset($_POST['listings']) && isset($_POST['SEARCH'])){

    $table_name=$_POST['aefi_Rtss_opd_list_datab'];
   
   if(!empty($_POST['aefi_Rtss_opd_list_datab'])){
...
$cluster_query = "SELECT cluster, count(cluster) as cnt2 FROM aefi_Rtss_opd_list_datab GROUP BY cluster ORDER BY cluster";
...
$grouping = '';
$grouping_query = "SELECT groupings, count(groupings) as cnt2 FROM aefi_Rtss_opd_list_datab GROUP BY groupings ORDER BY groupings";
...
$district = '';
$district_query ="SELECT district, count(district) as cnt3 FROM aefi_Rtss_opd_list_datab GROUP BY district ORDER BY district";
...
if (isset($_POST['filter_cluster'],$_POST['filter_grouping'], $_POST['filter_district']) && (!empty(trim($_POST['filter_cluster'])) && !empty(trim($_POST['filter_grouping'])) && !empty(trim($_POST['filter_district']))))
{
  ...
  $query_all="SELECT * FROM aefi_Rtss_opd_list_datab";
